...
export class Configuration {
    ...
    public MAP_DEFAULT_POSITION = [48.827208299999995, 2.2820185]; // initial position when geoloc not possible: Paris, FR
    public MAP_TILE_LAYER_URL = 'https://api.tiles.mapbox.com/v4/mapbox.streets/{z}/{x}/{y}.png?access_token=pk.eyJ1IjoiemJvdXppYW5lIiwiYSI6ImNpa28yZnNoaTAwOWl3MG00M2Q0MG1qcHIifQ.r3Ye8UdsaoAc3DuF6elmXQ';
